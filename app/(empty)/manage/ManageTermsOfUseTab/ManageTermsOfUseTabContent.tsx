...
export default function ManageTermsOfUseTabContent({ json }: { json: any }) {
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      <div className="sticky bottom-0 flex justify-center gap-2 pt-2">
        ...
        <Button color="primary" onPress={saveTermsOfUse}>
          שמור שינויים
        </Button>
      </div>
    </div>
  ...
  async function saveTermsOfUse() {
    ...
    try {
      ...
      await supabase.storage.from("files").update("terms-of-use.json", blob);
